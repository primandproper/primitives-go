...
import (
	...
	analyticssegment "github.com/primandproper/platform-go/v12/analytics/segment"
	authorizationcfg "github.com/primandproper/platform-go/v12/authorization/config"
	...
	cacheredis "github.com/primandproper/platform-go/v12/cache/redis"
	capitalismcfg "github.com/primandproper/platform-go/v12/capitalism/config"
	capitalismstripe "github.com/primandproper/platform-go/v12/capitalism/stripe"
	...
	distributedlockredis "github.com/primandproper/platform-go/v12/distributedlock/redis"
	emailcfg "github.com/primandproper/platform-go/v12/email/config"
	emailmailgun "github.com/primandproper/platform-go/v12/email/mailgun"
	emailmailjet "github.com/primandproper/platform-go/v12/email/mailjet"
	emailpostmark "github.com/primandproper/platform-go/v12/email/postmark"
	emailresend "github.com/primandproper/platform-go/v12/email/resend"
	emailsendgrid "github.com/primandproper/platform-go/v12/email/sendgrid"
	emailses "github.com/primandproper/platform-go/v12/email/ses"
	embeddingscohere "github.com/primandproper/platform-go/v12/embeddings/cohere"
	embeddingscfg "github.com/primandproper/platform-go/v12/embeddings/config"
	embeddingsopenai "github.com/primandproper/platform-go/v12/embeddings/openai"
	eventstreamcfg "github.com/primandproper/platform-go/v12/eventstream/config"
	featureflagscfg "github.com/primandproper/platform-go/v12/featureflags/config"
	featureflagslaunchdarkly "github.com/primandproper/platform-go/v12/featureflags/launchdarkly"
	featureflagsposthog "github.com/primandproper/platform-go/v12/featureflags/posthog"
	llmanthropic "github.com/primandproper/platform-go/v12/llm/anthropic"
	llmcfg "github.com/primandproper/platform-go/v12/llm/config"
	llmopenai "github.com/primandproper/platform-go/v12/llm/openai"
	messagequeuecfg "github.com/primandproper/platform-go/v12/messagequeue/config"
	asyncably "github.com/primandproper/platform-go/v12/notifications/async/ably"
	asyncnotifcfg "github.com/primandproper/platform-go/v12/notifications/async/config"
	asyncpusher "github.com/primandproper/platform-go/v12/notifications/async/pusher"
	"github.com/primandproper/platform-go/v12/notifications/mobile/apns"
	mobilecfg "github.com/primandproper/platform-go/v12/notifications/mobile/config"
	loggingcfg "github.com/primandproper/platform-go/v12/observability/logging/config"
	loggingotelgrpc "github.com/primandproper/platform-go/v12/observability/logging/otelgrpc"
	metricscfg "github.com/primandproper/platform-go/v12/observability/metrics/config"
	metricsotelgrpc "github.com/primandproper/platform-go/v12/observability/metrics/otelgrpc"
	profilingcfg "github.com/primandproper/platform-go/v12/observability/profiling/config"
	profilingpprof "github.com/primandproper/platform-go/v12/observability/profiling/pprof"
	profilingpyroscope "github.com/primandproper/platform-go/v12/observability/profiling/pyroscope"
	tracingcloudtrace "github.com/primandproper/platform-go/v12/observability/tracing/cloudtrace"
	tracingcfg "github.com/primandproper/platform-go/v12/observability/tracing/config"
	tracingoteltrace "github.com/primandproper/platform-go/v12/observability/tracing/oteltrace"
	routingchi "github.com/primandproper/platform-go/v12/routing/backends/chi"
	routinggin "github.com/primandproper/platform-go/v12/routing/backends/gin"
	routinghttprouter "github.com/primandproper/platform-go/v12/routing/backends/httprouter"
	routingstdlib "github.com/primandproper/platform-go/v12/routing/backends/stdlib"
	routingcfg "github.com/primandproper/platform-go/v12/routing/config"
	textsearchalgolia "github.com/primandproper/platform-go/v12/search/text/algolia"
	textsearchcfg "github.com/primandproper/platform-go/v12/search/text/config"
	textsearchelasticsearch "github.com/primandproper/platform-go/v12/search/text/elasticsearch"
	vectorsearchcfg "github.com/primandproper/platform-go/v12/search/vector/config"
	vectorsearchpgvector "github.com/primandproper/platform-go/v12/search/vector/pgvector"
	vectorsearchqdrant "github.com/primandproper/platform-go/v12/search/vector/qdrant"
	secretscfg "github.com/primandproper/platform-go/v12/secrets/config"
	secretsgcp "github.com/primandproper/platform-go/v12/secrets/gcp"
	secretskubernetes "github.com/primandproper/platform-go/v12/secrets/kubernetes"
	secretsssm "github.com/primandproper/platform-go/v12/secrets/ssm"
