...
[github.com/primandproper/primitives-go/v2/encoding], so what is written is what
the LoadFrom* side reads.

# The variables themselves

[github.com/primandproper/primitives-go/v2/config/envvars] answers what the
