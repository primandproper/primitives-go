// Package authorizationmock provides moq-generated mock implementations of interfaces in
...
//go:generate go tool github.com/matryer/moq -out authorization_mock.go -pkg authorizationmock -rm -fmt goimports .. PolicyResolver:PolicyResolverMock
