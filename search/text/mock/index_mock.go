...
//			},
//			SearchFunc: func(ctx context.Context, req textsearch.SearchRequest) (*textsearch.SearchResults[T], error) {
...
func (mock *IndexMock[T]) Search(ctx context.Context, req textsearch.SearchRequest) (*textsearch.SearchResults[T], error) {
