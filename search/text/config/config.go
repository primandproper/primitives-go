...
import (
	...
	"github.com/primandproper/platform-go/v5/search/text/algolia"
	"github.com/primandproper/platform-go/v5/search/text/elasticsearch"
	"github.com/primandproper/platform-go/v5/search/text/noop"
