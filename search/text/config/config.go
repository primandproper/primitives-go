...
import (
	...
	"github.com/primandproper/platform-go/v11/search/text/algolia"
	"github.com/primandproper/platform-go/v11/search/text/elasticsearch"
	"github.com/primandproper/platform-go/v11/search/text/noop"
