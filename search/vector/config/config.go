...
import (
	...
	"github.com/primandproper/platform-go/v8/search/vector/noop"
	"github.com/primandproper/platform-go/v8/search/vector/pgvector"
	"github.com/primandproper/platform-go/v8/search/vector/qdrant"
