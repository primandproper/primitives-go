...
import (
	...
	"github.com/primandproper/platform-go/v5/search/vector/noop"
	"github.com/primandproper/platform-go/v5/search/vector/pgvector"
	"github.com/primandproper/platform-go/v5/search/vector/qdrant"
