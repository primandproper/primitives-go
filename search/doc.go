...
[github.com/primandproper/primitives-go/search/text] and
[github.com/primandproper/primitives-go/search/vector] are deliberate mirrors:
...
[github.com/primandproper/primitives-go/embeddings] — and applications that
...
[github.com/primandproper/primitives-go/search/sync] is the write side. The
index event is enqueued in the transaction that changed the row, through
[github.com/primandproper/primitives-go/outbox], and applied afterwards from a
...
[github.com/primandproper/primitives-go/search/pagination] is the read side. A
text index's cursor and a
[github.com/primandproper/primitives-go/filtering.QueryFilter]'s cursor travel
...
[github.com/primandproper/primitives-go/embeddings] and
[github.com/primandproper/primitives-go/llm]. They are an application's
