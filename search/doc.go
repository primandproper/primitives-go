...
[github.com/primandproper/primitives-go/v2/search/text] and
[github.com/primandproper/primitives-go/v2/search/vector] are deliberate mirrors:
...
[github.com/primandproper/primitives-go/v2/embeddings] — and applications that
...
[github.com/primandproper/primitives-go/v2/search/sync] is the write side. The
index event is enqueued in the transaction that changed the row, through
[github.com/primandproper/primitives-go/v2/outbox], and applied afterwards from a
...
[github.com/primandproper/primitives-go/v2/search/pagination] is the read side. A
text index's cursor and a
[github.com/primandproper/primitives-go/v2/filtering.QueryFilter]'s cursor travel
...
[github.com/primandproper/primitives-go/v2/embeddings] and
[github.com/primandproper/primitives-go/v2/llm]. They are an application's
