...
func TestSchema_DocumentStructure(T *testing.T) {
	...
	T.Run("exact set of component schemas", func(t *testing.T) {
		...
		want := []string{
			...
			"HttpAPIError",
			"HttpAPIResponseGithubComPrimandproperPrimitivesGoV2RoutingTestReferenceUser",
			"HttpAPIResponseGithubComPrimandproperPrimitivesGoV2RoutingTestStressAllTypes",
			"HttpResponseDetails",
