...
func (mock *UploadManagerMock) Close() error {
	if mock.CloseFunc == nil {
		panic("UploadManagerMock.CloseFunc: method is nil but UploadManager.Close was just called")
	}
	callInfo := struct {
	}{}
	mock.lockClose.Lock()
...
//
//	len(mockedUploadManager.CloseCalls())
func (mock *UploadManagerMock) CloseCalls() []struct {
} {
	var calls []struct {
	}
