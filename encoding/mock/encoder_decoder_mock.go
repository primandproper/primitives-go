...
//			},
//			RespondWithDataFunc: func(ctx context.Context, res http.ResponseWriter, val any)  {
//				panic("mock out the RespondWithData method")
//			},
//		}
//
...
type ServerEncoderDecoderMock struct {
	...
	// RespondWithDataFunc mocks the RespondWithData method.
	RespondWithDataFunc func(ctx context.Context, res http.ResponseWriter, val any)
	...
	calls struct {
		...
		// RespondWithData holds details about calls to the RespondWithData method.
		RespondWithData []struct {
			// Ctx is the ctx argument value.
			Ctx context.Context
			// Res is the res argument value.
			Res http.ResponseWriter
	...
	lockRespondWithData          sync.RWMutex
}
...
// RespondWithData calls RespondWithDataFunc.
func (mock *ServerEncoderDecoderMock) RespondWithData(ctx context.Context, res http.ResponseWriter, val any) {
	if mock.RespondWithDataFunc == nil {
		panic("ServerEncoderDecoderMock.RespondWithDataFunc: method is nil but ServerEncoderDecoder.RespondWithData was just called")
	}
	callInfo := struct {
		Ctx context.Context
		Res http.ResponseWriter
	...
	mock.lockRespondWithData.Lock()
	mock.calls.RespondWithData = append(mock.calls.RespondWithData, callInfo)
	mock.lockRespondWithData.Unlock()
	mock.RespondWithDataFunc(ctx, res, val)
}

// RespondWithDataCalls gets all the calls that were made to RespondWithData.
// Check the length with:
//
//	len(mockedServerEncoderDecoder.RespondWithDataCalls())
func (mock *ServerEncoderDecoderMock) RespondWithDataCalls() []struct {
	Ctx context.Context
	Res http.ResponseWriter
	Val any
} {
	...
	mock.lockRespondWithData.RLock()
	calls = mock.calls.RespondWithData
	mock.lockRespondWithData.RUnlock()
	return calls
}
