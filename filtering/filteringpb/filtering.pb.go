...
// its canonical name:
//
//	PLATFORM_PROTO := $(shell go list -m -f '{{.Dir}}' github.com/primandproper/primitives-go)/filtering/proto
//
...
// github.com/primandproper/primitives-go/filtering/filteringpb, and the
...
const file_primandproper_platform_filtering_v1_filtering_proto_rawDesc = "" +
	...
	"\fcounts_known\x18\a \x01(\bR\vcountsKnownBJZHgithub.com/primandproper/primitives-go/filtering/filteringpb;filteringpbb\x06proto3"
